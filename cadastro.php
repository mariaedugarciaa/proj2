...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $confirmouemail = test_input($_POST["confirmouemail"]);
        $tel = test_input($_POST["tel"]);
        
        $datacadastro = test_input($_POST["datacadastro"]);
        ...
        $sql = "tb_usuario where email='" . $email . "' and senha='" . $senha . "'";
    ...
    <main class="form-signin w-25 m-auto">
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            ...
            <div class="form-floating">
                <input name="nome" type="text" class="form-control" id="floatingName" placeholder="Name">
            ...
            <div class="form-floating">
                <input name="tel" type="text" class="form-control" id="floatingTelefone" placeholder="Tel">
                <label for="floatingTelefone">Telefone</label>
            </div>
            <div class="form-floating">
                <input name="cpf" type="text" class="form-control" id="floatingCpf" placeholder="Password">
